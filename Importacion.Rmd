...
```
Si tuviese que cerrar un día, obviamente sería el domingo, donde solo se encuentran 3 tickets. Haciendo un poco más de indagación, debido a que los domingos ningún Mercadona abre por normativa, hemos descubierto que estos 3 tickets corresponden a uno solo, del 24/12/2023 en Benijofar.
Por extraño que parezca, debido a que es un ticket real, no se puede considerar outlier por lo que el día que menos se vende es domingo según nuestros datos. 
