...
#Eliminamos aquellos que contengan O╠é ya que no nos sirven(repetidos)
pdfs <- pdfs[!str_detect(pdfs,pattern = "O╠é")] %>% lapply(pdf_text)
...
-   ¿Cuando se hacen más compras en las diferentes partes del día: mañana, tarde y noche?
