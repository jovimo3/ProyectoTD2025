...
```{r results='hide'}
# Filtrar t_compras para mantener solo los dataframes con 7 columnas (tickets con un formato correcto)
t_compras <- t_compras[sapply(t_compras, function(df) ncol(df) == 7)]
...
# Filtramos l_head para que contenga solo las listas con más de 5 elementos (tenga el formato correcto de un ticket)
l_head <- l_head[sapply(l_head, length) > 5]
