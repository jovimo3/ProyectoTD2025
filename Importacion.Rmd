---
title: "Importacion"
author: "Morales Martorell, Josep Vicent, Rocio Bono Moreno, Laura Horjales Rivas, Arnau Hernández Lucas y Pau García Pérez."
date: "2025-04-03"
output:
...
save(df_p, file = "data/1_df_general.RData")
```
...
Como se observa en esta tabla los 5 productos más vendidos de frutas o verduras son: el plátano (vendiendo un total de 62.868 kg), la banana (vendiendo 28.140 kg), la sandia baja semillas (22.843 kg), pepino (19.624 kg) y el calabacín verde (17.754 kg).
...
Se observa que "almendra natural" se suele comprar con "cacahuete chocolate", "pepino" o "barrita muesli choco" y el "pan semillas" con "atun claro oliva".
...
=======
-   ¿Que productos son los más comprados durante las diferentes estaciones, verano (junio - agosto),  invierno(diciembre - marzo)... ? (representación gráfica) 
...
-   ¿Hay relación con precio medio de los productos y la cantidad de productos de la compra? 
...
>>>>>>> 8f57bc26aec6548212ade53ee2de8a931251e5dc


-   ¿Como ha variado el precio del aceite, y relacionados, a lo largo del tiempo, haz una gráfica para apreciarlo mejor?
...
```
    ...
    Según nuestros datos, como se ve en la gráfica, se nota una gran subida de precio en el aceite virgen y virgen ex durante la primavera, y después baja progresivamente. Los otros productos no se ven muy afectados.
...
df_parking_tiempos |>
  ...
  arrange(tiempo_diferencia) |>
  mutate(orden = row_number()) |>
  ggplot(aes(x = orden, y = tiempo_diferencia)) +
  geom_point() +
  labs(title = "Distribución Tiempo Compra Segun Tiempo Parking", 
       x = "Índice ordenado", y = "Tiempo (min)")
